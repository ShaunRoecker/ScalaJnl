...
//         AccountNumber.wrapAll(List(1, 2, 3))
...
//     val chunkOSequenceNumber: Chunk[SequenceNumber] =
//         SequenceNumber.wrapAll(Chunk(14563, 32045, 85833, 242354))

//     val chunkOInts: Chunk[Int] =
//         SequenceNumber.unwrap(chunkOSequenceNumber)
